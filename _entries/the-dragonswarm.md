...
entry:
  ...
  main_description: |-
    ...
    It is a dangerous connection, one that threatens to consume him. Can he pay even that ultimate price if it means the salvation of humanity?" -- Aaron Pogue
connections:
  - has_connection_to_entry: "Aaron Pogue"
    details_of_connection: "author"
  - has_connection_to_entry: "Taming Fire"
