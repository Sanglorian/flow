...
- `category` (string or array): primary category. Most entries use a single string (`Work`, `Collection`, `Source`, `Organisation`). Entries with multiple categories should use an array (e.g., `- Work`, `- Collection`).
